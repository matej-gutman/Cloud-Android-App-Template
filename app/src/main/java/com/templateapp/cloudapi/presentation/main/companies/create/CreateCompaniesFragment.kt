...
import com.templateapp.cloudapi.databinding.FragmentCreateCompanyBinding
...
class CreateCompaniesFragment : BaseAccountFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCreateCompanyBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun add() {
        ...
        viewModel.onTriggerEvent(CreateCompanyEvents.PublishCompany(activity))
    ...
    fun subscribeObservers() {
        viewModel.state.observe(viewLifecycleOwner, { state ->
            ...
            processQueue(
                ...
                stateMessageCallback = object : StateMessageCallback {
                    override fun removeMessageFromStack() {
                        viewModel.onTriggerEvent(CreateCompanyEvents.OnRemoveHeadFromQueue)
                    }
                })
            ...
            if (state.onPublishSuccess) {
                Toast.makeText(context,"You have successfully added new company",Toast.LENGTH_LONG).show()
            }
        })
    }

    private fun setCompanyProperties(
        title: String,
    ) {
    ...
    private fun cacheState() {
        ...
        viewModel.onTriggerEvent(CreateCompanyEvents.OnUpdateTitle(title))
